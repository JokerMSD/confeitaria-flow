...
import { Search, Plus, Clock, MoreVertical, X, Calendar, DollarSign, Filter, Trash2 } from "lucide-react";
...
export default function Pedidos() {
  ...
  const [orders, setOrders] = useMockData("orders", mockOrders);
            ...
            <div className="col-span-full py-12 text-center text-muted-foreground bg-card/50 rounded-2xl border border-dashed border-border">
              ...
              {(searchTerm || statusFilter !== 'todos' || dateFilter || paymentFilter !== 'todos') && (
                <Button variant="link" onClick={() => {
                  setSearchTerm(""); setStatusFilter("todos"); setDateFilter(""); setPaymentFilter("todos");
              ...
              >
                <div className="p-5 flex flex-col h-full gap-4 relative">
                  ...
                  <div className={cn(
                    ...
                    order.status === 'Em produção' ? "bg-amber-400" :
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm mt-4">
                      <div className={cn(
                        ...
                        order.deliveryDate < new Date().toISOString().split('T')[0] && order.status !== 'Entregue' && order.status !== 'Cancelado'
