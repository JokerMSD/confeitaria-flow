...
export default function Receitas() {
  ...
  const [kindFilter, setKindFilter] = useState<"todos" | "Preparacao" | "ProdutoVenda">(
    "todos",
  );
    ...
    <AppLayout title="Receitas">
      <div className="space-y-6">
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground">
                Cadastre bases, recheios e produtos de venda com custo real.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 bg-card p-4 rounded-xl border border-border/50">
