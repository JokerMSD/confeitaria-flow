...
- A API autoaplica migrations `.sql` pendentes no startup por padrao, tenta reaplicar seletivamente migrations sugeridas pela guarda quando o historico estiver inconsistente e so depois valida o schema critico antes de abrir as rotas.
